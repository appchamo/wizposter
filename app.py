...
# ---------------------------------------------------------------- páginas legais
_LEGAL_CSS = """*{box-sizing:border-box;margin:0}body{font-family:-apple-system,Segoe UI,Roboto,sans-serif;background:#0d0d12;color:#e8e8ea;line-height:1.65}.wrap{max-width:780px;margin:0 auto;padding:48px 22px}h1{font-size:30px;margin-bottom:6px}.logo{font-size:20px;font-weight:800;letter-spacing:1px;margin-bottom:30px}.logo span{color:#fe2c55}h2{font-size:19px;margin:26px 0 8px}small{color:#9a9aa2}p{margin:10px 0}a{color:#fe2c55}ul{margin:10px 0 10px 22px}li{margin:6px 0}.foot{margin-top:40px;color:#6a6a72;font-size:13px}"""
...
<p class="foot">© Wiz Mídia — Patrocínio-MG, Brasil · <a href="/">Início</a> · <a href="/terms">Termos</a> · <a href="/privacy">Privacidade</a></p>
</div></body></html>""")
...
def terms():
    ...
    <p>O Wiz Poster é uma plataforma web operada pela Wiz Mídia que permite a criadores de conteúdo conectar suas contas do TikTok e enviar, publicar e agendar seus próprios vídeos. Ao usar o serviço, você concorda com estes Termos.</p>
    <h2>1. Descrição do serviço</h2>
    <p>Após autorização via login oficial do TikTok (OAuth), o criador pode enviar vídeos para sua própria conta como rascunho ou publicação, imediatamente ou em horário agendado, por meio da Content Posting API oficial do TikTok.</p>
    <h2>2. Conta e autorização</h2>
    <p>O serviço só acessa contas que o próprio criador autorizou explicitamente pelo fluxo oficial do TikTok. A autorização pode ser revogada a qualquer momento.</p>
    <h2>3. Uso adequado</h2>
    <p>O usuário se compromete a enviar apenas conteúdo de sua autoria ou devidamente licenciado, respeitando as Diretrizes da Comunidade e os Termos de Serviço do TikTok.</p>
    <h2>4. Garantias</h2>
    <p>O serviço é fornecido "como está". A Wiz Mídia não se responsabiliza por indisponibilidades do TikTok ou penalidades decorrentes do conteúdo publicado pelo usuário.</p>
    <h2>5. Contato</h2><p>Dúvidas: raferaissa@gmail.com</p>""")
...
def privacy():
    ...
    <p>Esta política descreve como o Wiz Poster, operado pela Wiz Mídia, trata os dados dos criadores que usam a plataforma.</p>
    <h2>1. Dados que coletamos</h2>
    <ul><li>Dados básicos do perfil TikTok (open_id, nome de exibição e avatar), via Login Kit oficial;</li>
    <li>Tokens de autorização emitidos pelo TikTok;</li>
    <li>Os vídeos e legendas que o criador envia para publicação.</li></ul>
    <p>Não coletamos senhas (o login acontece no próprio TikTok) nem dados de pagamento.</p>
    <h2>2. Como usamos os dados</h2>
    <p>Exclusivamente para operar o serviço: identificar a conta conectada e enviar/publicar/agendar os vídeos que o próprio criador solicitar, sempre na conta dele.</p>
    <h2>3. Compartilhamento</h2>
    <p>Não vendemos nem compartilhamos dados com terceiros. A única transmissão ocorre entre o serviço e os servidores oficiais do TikTok.</p>
    <h2>4. Armazenamento e segurança</h2>
    <p>Tokens e arquivos ficam na infraestrutura do serviço com acesso restrito, pelo tempo necessário. Vídeos são mantidos só até a publicação.</p>
    <h2>5. Direitos e retenção</h2>
    <p>O criador pode desconectar a conta no painel, revogar a autorização no TikTok ou pedir exclusão dos dados pelo e-mail abaixo, quando quiser.</p>
    <h2>6. Contato</h2><p>Dúvidas: raferaissa@gmail.com</p>""")
